package com.sht.connector.redis.table;
...
public class RedisDynamicTableSink implements DynamicTableSink {
    ...
    public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
        String host = options.get(RedisDynamicTableSinkFactory.host);
        FlinkJedisPoolConfig.Builder builder = new FlinkJedisPoolConfig.Builder().setHost(host);
        Integer port = options.get(RedisDynamicTableSinkFactory.port);
        if(port != null){
